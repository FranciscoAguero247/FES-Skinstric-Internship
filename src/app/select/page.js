...
function SelectResultsContent() {
  ...
  const detailsQuery = rawDetails ? `?details=${encodeURIComponent(rawDetails)}` : '';
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-between antialiased text-[#1A1B1C] bg-white overflow-hidden">
          ...
          <div className="relative w-[550px] h-[550px] flex items-center justify-center">
            ...
            <div className="relative z-10 grid grid-cols-3 grid-rows-3 gap-0">
              ...
              <div 
                ...
                onMouseLeave={() => setHoveredNode(null)}
              >
                <button className="w-[153.88px] h-[153.88px] bg-gray-100 hover:bg-gray-300 transform rotate-45 flex items-center justify-center -m-5 font-semibold leading-[24px] tracking-tight uppercase hover:scale-[1.05] transition-transform duration-300 cursor-not-allowed">
      ...
      <div className="w-full flex justify-between px-9 pb-8 z-30 items-center">
        ...
        <button 
          onClick={() => router.push(`/summary${detailsQuery}`)}
          className="group flex items-center focus:outline-none"
        >
          <div className="flex items-center">
            <div className="hidden sm:flex flex-row relative justify-center items-center">
